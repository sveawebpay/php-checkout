...
| BillingAddress                | [*Address*](#87-address)              | Billing [*Address*](#87-address) of identified customer. |
...
| SveaWillBuyOrder              | String               | Only set if merchant has no-risk flow enabled, which means that all invoice orders will be accepted. This value will be true if Svea buys the invoice. |
