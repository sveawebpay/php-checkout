...
class GetOrderDeliveryTest extends TestCase
{
    /**
     * @var ValidateGetOrderDeliveryData|\PHPUnit_Framework_MockObject_MockObject $validatorMock
     */
    ...
    public function setUp()
    {
        ...
        $this->validatorMock = $this->getMockBuilder('\Svea\Checkout\Validation\Admin\ValidateGetOrderDeliveryData')->getMock();
